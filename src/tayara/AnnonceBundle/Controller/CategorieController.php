...
use tayara\AnnonceBundle\Entity\Categorie;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('tayaraAnnonceBundle:Categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('tayara\AnnonceBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('tayara\AnnonceBundle\Form\CategorieType', $categorie);
